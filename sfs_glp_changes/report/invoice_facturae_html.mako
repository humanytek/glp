...
<body>
    %for o in objects :
                            ...
                            <td class="td_data_exp">
                                <div class="fiscal_address">
                                    %if o.payment_term.name:
                                        <b>Condición de pago: ${o.payment_term.note or o.payment_term.name or ''|entity}</b>
                                    %endif
            ...
            <tr>
                <td width="80%">
                    ...
                    <table class="basic_table">
                        <tr>
                            ...
                            <td class="cliente">
                            	<%ref=get_salesperson(o.partner_id) or ''%>${ref}
                            ...
                            <td class="cliente">
                            	<%zona=get_zona(o.partner_id)%>${zona}
                            </td>
                        </tr>
                    </table>
                ...
                <td width="19%" align="center">
                    ...
                    %if o.invoice_sequence_id.approval_id.type != 'cbb':
                        ...
                        <br/>${_("Año de Aprobación:")} ${get_approval() and get_approval().approval_year or _("No válido")|entity}
                    %endif
                </td>
            </tr>
        </table>
        ...
        <br clear="all" />
        <table>
        	<tr width="33%"><b><%uos_qty=get_uos_qty(o.id)%>${_("Total de Cajas: ")}${uos_qty}</b></tr>
        </table>
        <table class="basic_table">
            <tr>
                <td class="tax_td">
        ...
        %if o.company_emitter_id.partner_id.bank_ids:
            ...
            <table class="basic_table" rules="all">
                <tr>
                    ...
                    <td class="data_bank_label">${_('Referencia Bancaria')}</td>
                    <td class="data_bank_label" width="30%">${_('Clave Interbancaria Estandarizada (CLABE)')}</td>
                    <td class="data_bank_label">${_('Convenio')}</td>
                </tr>
                %for f in o.company_emitter_id.partner_id.bank_ids:
                    <tr>
                        ...
                        <td class="center_td"><%ref=get_partner_bank_ref(o.partner_id) or ''%>
                   ${ref}</b></td>
                        <td class="center_td">${_('014320655038073557')}</td>
                        <td class="center_td">${_('4109')}</td>
                    </tr>
                %endfor
            </table>
        %endif
            ...
            <div style="page-break-inside:avoid; border:1.5px solid grey;">
                <table width="100%" class="datos_fiscales">
                    ...
                    <tr>
                        ...
                        %if o.cfdi_cbb:
                        <td align="right">
                            ${helper.embed_image('jpeg',str(o.cfdi_cbb), 90, 90)}
                        </td>
                        %endif
                    </tr>
                </table>
    ...
    <br/><br/>
   	<div style="page-break-inside:avoid; border:1.5px solid grey;">
        <table width="100%">
            ...
            <tr>
         		<td class="basic_td">
                   <%ref = get_text_promissory(o.company_id, o.partner_id, o) or ''%>
                   		 ${ref or ''}
                </td>
            </tr>
            </table>
